...
const add = (numb1, numb2) => parseInt(numb1) + parseInt(numb2);
...
console.log(bestMovie(`Spider-Man`));
...
contestants = theEliminator(contestants, loser);
...
const chocolateFrog = (gold) => {
  const totalFrogs = Math.floor(gold / 3);
  return totalFrogs;
};

const totalFrogs = chocolateFrog(45);
...
const chocolateFrog2 = (gold) => {
  const totalFrogs = Math.floor(gold / 3);
  return totalFrogs;
};

const totalFrogs2 = chocolateFrog2(45);
console.log(totalFrogs2);

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0, 1, 2, 3, 4, 6, 5, 7, 8, 9];
/*
...
const arrayIsAscending = ascArr(sampleArray);
